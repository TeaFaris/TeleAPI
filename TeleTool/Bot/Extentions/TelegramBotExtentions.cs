...
namespace TeleTool.Bot.Extentions
{
    public static class TelegramBotExtentions
    {
        #region Receive
        public static async Task<Message> ReceiveMessageAsync<TDB, TCredits>(this TelegramBot<TDB, TCredits> Bot, CustomUser User) where TDB : TelegramDBContext, IDBContext<TCredits> where TCredits : IDBCredentials
        {
        ...
        public static async Task<PhotoSize[]?> ReceivePhotoAsync<TDB, TCredits>(this TelegramBot<TDB, TCredits> Bot, CustomUser User) where TDB : TelegramDBContext, IDBContext<TCredits> where TCredits : IDBCredentials => (await ReceiveMessageAsync(Bot, User)).Photo;
        public static async Task<Video?> ReceiveVideoAsync<TDB, TCredits>(this TelegramBot<TDB, TCredits> Bot, CustomUser User) where TDB : TelegramDBContext, IDBContext<TCredits> where TCredits : IDBCredentials => (await ReceiveMessageAsync(Bot, User)).Video;
        public static async Task<Audio?> ReceiveAudioAsync<TDB, TCredits>(this TelegramBot<TDB, TCredits> Bot, CustomUser User) where TDB : TelegramDBContext, IDBContext<TCredits> where TCredits : IDBCredentials => (await ReceiveMessageAsync(Bot, User)).Audio;
        public static async Task<Sticker?> ReceiveStickerAsync<TDB, TCredits>(this TelegramBot<TDB, TCredits> Bot, CustomUser User) where TDB : TelegramDBContext, IDBContext<TCredits> where TCredits : IDBCredentials => (await ReceiveMessageAsync(Bot, User)).Sticker;
        public static async Task<Document?> ReceiveDocumentAsync<TDB, TCredits>(this TelegramBot<TDB, TCredits> Bot, CustomUser User) where TDB : TelegramDBContext, IDBContext<TCredits> where TCredits : IDBCredentials => (await ReceiveMessageAsync(Bot, User)).Document;
        public static async Task<Animation?> ReceiveAnimationAsync<TDB, TCredits>(this TelegramBot<TDB, TCredits> Bot, CustomUser User) where TDB : TelegramDBContext, IDBContext<TCredits> where TCredits : IDBCredentials => (await ReceiveMessageAsync(Bot, User)).Animation;
        public static async Task<Location?> ReceiveLocationAsync<TDB, TCredits>(this TelegramBot<TDB, TCredits> Bot, CustomUser User) where TDB : TelegramDBContext, IDBContext<TCredits> where TCredits : IDBCredentials => (await ReceiveMessageAsync(Bot, User)).Location;
        public static async Task<string?> ReceiveStringAsync<TDB, TCredits>(this TelegramBot<TDB, TCredits> Bot, CustomUser User) where TDB : TelegramDBContext, IDBContext<TCredits> where TCredits : IDBCredentials
        {
            Message RecievedMessage = await ReceiveMessageAsync(Bot, User);
            return RecievedMessage.Text ?? RecievedMessage.Caption;
        }
        public static async Task<Num?> ReceiveNumberAsync<TDB, TCredits, Num>(this TelegramBot<TDB, TCredits> Bot, CustomUser User) where TDB : TelegramDBContext, IDBContext<TCredits> where TCredits : IDBCredentials where Num : INumber<Num>
        {
        ...
        public static async Task SendChatActionAsync<TDB, TCredits>(this TelegramBot<TDB, TCredits> Bot, CustomUser User, ChatAction ChatAction, CancellationToken CancellationToken = default) where TDB : TelegramDBContext, IDBContext<TCredits> where TCredits : IDBCredentials => await Bot.Api.SendChatActionAsync(User.UserID, ChatAction, CancellationToken);
